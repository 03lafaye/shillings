...
public class Denominations {
    ...
    private Denominations(Context context) {
        ...
        Currency usd = new Currency("United States Dollar", "$", context.getResources().getDrawable(R.drawable.usa));
        usd.setCoinDenominations(new Integer[] {});
        usd.setPaperDenominations(new Integer[] { 1, 5, 10, 20, 50, 100, 1000 });
        ...
        mCurrencies.get(Dirham).put(mCurrencies.get(Dollar), 0.2723);
        mCurrencies.get(Dirham).put(mCurrencies.get(Shilling), 23.1881);

        mCurrencies.get(Dollar).put(mCurrencies.get(Dirham), 3.6730);
        mCurrencies.get(Dollar).put(mCurrencies.get(Shilling), 85.17);

        mCurrencies.get(Shilling).put(mCurrencies.get(Dirham), 0.0431);
        mCurrencies.get(Shilling).put(mCurrencies.get(Dollar), 0.0117);
